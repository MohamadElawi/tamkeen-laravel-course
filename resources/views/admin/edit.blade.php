        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('manage.admins.update', $admin) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone', $admin->phone)" required />
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('manage.admins') }}" class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">
                                {{ __('Cancel') }}
                            </a>
                        </div>
                    </form>
