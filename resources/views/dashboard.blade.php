                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-md transition-shadow duration-300">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Browse Products</h3>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Explore our collection of products</p>
                            </div>
                        </div>
                        <div class="mt-4">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400">View your order history</p>
                            </div>
                        </div>
                        <div class="mt-4">
